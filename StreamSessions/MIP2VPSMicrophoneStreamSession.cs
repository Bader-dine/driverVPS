...
namespace MIP2VPS
{
    ...
    /// </summary>
    internal class MIP2VPSMicrophoneStreamSession : BaseMIP2VPSStreamSession
    {
        ...
        public MIP2VPSMicrophoneStreamSession(ISettingsManager settingsManager, MIP2VPSConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId) :

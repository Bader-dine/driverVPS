...
namespace MIP2VPS
{
    ...
    /// </summary>
    internal class MIP2VPSVideoStreamSession : BaseMIP2VPSStreamSession
    {

        public MIP2VPSVideoStreamSession(ISettingsManager settingsManager, MIP2VPSConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId) :
